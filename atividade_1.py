...
# Verificar se as colunas do DataFrame para identificar possíveis problemas
print([coluna for coluna in data.columns])

# Se houver espaços extras nos nomes das colunas, serve para remover
